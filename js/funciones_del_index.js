document.addEventListener("DOMContentLoaded", () => {
   ...
   *  Informa al usuario cambiando el color del boton y su contenido
   * @param {*} product JSON del producto
   * @param {*} e Evento click generado
   */
  function agregarAlCartito(product, e) {
